...
const Auth = () => {
  return (
    ...
    >
      ...
      >
        <Text style={{ fontWeight: "bold", fontSize: 23, paddingTop: 20 }}>
          The One-Stop Advisor for all your
        </Text>
        <Text style={{ fontWeight: "bold", fontSize: 23, paddingBottom: 25 }}>
          Financial Needs
        </Text>
        ...
        >
          ...
          <View>
            <Text style={{ width: 120, textAlign: "center", color: "#525252" }}>
              Log in or Sign Up
            </Text>
          </View>
          <View style={{ flex: 1, height: 1, backgroundColor: "#525252" }} />
        ...
        >
          ...
          >
            <TouchableOpacity>
              <Text style={{ fontSize: 10, flex: 1 }}>Terms of Service </Text>
            </TouchableOpacity>
            <TouchableOpacity>
              <Text style={{ fontSize: 10, flex: 1 }}>Privacy Policy </Text>
            </TouchableOpacity>
            <TouchableOpacity>
              <Text style={{ fontSize: 10, flex: 1 }}>Content Policy </Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
