...
class API {
  ...
  async getLoans(phone) {

    try {
      const response = await axios.get(baseURL + '/loan/' + phone);
  ...
  async setLoans(phone, value1, value2, value3) {
  
    try {
      const response = await axios.post(baseURL + '/loan/' + phone,
